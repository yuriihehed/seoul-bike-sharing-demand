...
*Part L — predictions with the final model on new observations;
title "New Observations for Prediction";
data new_data;
...
proc reg data=bike_data outest=estimates;
...
title "Predictions for New Observations";
